...
public class EMail {
	...
	String pass = "Pro@12345";
	
	public static void main(String a[])
	{
		RegBean rb = new RegBean();
		rb.setEmailid("dugar_ashish@yahoo.com");
		
		new EMail().sendMail(rb);
	}
